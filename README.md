...
In attempt to clone a dynamic social application, I've opted to clone Quora's website, a highly revered online platform used as a public question and answer (Q & A)forum. Question Aura was named in light of the discourse that evolves from a question, hence the appending name "Aura" - which by definition, means "the distinctive atmosphere or quality that seems to surround and be generated by a person, thing, or place." (Google.com).
